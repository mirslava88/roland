...
const lessons: Lesson[] = [
  ...
  { title: 'Таймер доклада', text: 'Нажмите «Таймер доклада». Здесь задаются время выступления, оформление и звуковые предупреждения.', selector: '[data-toolbar-item="timer"] button:first-child', kind: 'panel', panelSelector: '[data-pdm-training-panel="timer"]' },
