            ...
            <div className="space-y-5 text-xs text-gray-300 leading-relaxed">
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>PPTX и PDF начинают готовиться сразу после добавления в канал: PowerPoint создаёт превью и полноразмерные слайды, а PDF — эфирные страницы под разрешение выбранного дисплея. Пока идёт подготовка, на карточке виден статус <code className="text-gray-300 bg-surface-400 px-1 rounded-sm">Кэширование…</code></li>
