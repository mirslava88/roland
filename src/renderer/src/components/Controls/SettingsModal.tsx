            ...
            <div className="space-y-4 text-xs text-gray-300 leading-relaxed">
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>снимки памяти при загрузке и закрытии материала, а также аварии renderer и дочерних процессов.</li>
                </ul>
              </section>
            </div>
          )}
            ...
            <div className="space-y-5 text-xs text-gray-300 leading-relaxed">
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>Раздельная кнопка <code className="text-gray-300 bg-surface-400 px-1 rounded-sm">▣ Картинка в картинке</code> слева от кнопки «Фон» быстро включает и выключает режим с сохранёнными параметрами; соседняя шестерёнка открывает предварительную настройку</li>
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>«Скрыть все титры» одновременно убирает оба слоя. В режиме «Картинка в картинке» титры выводятся внутри окна участника и не закрывают основной материал; при обычном показе PPTX, PDF и видео они скрыты</li>
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>Кнопка <code className="text-gray-300 bg-surface-400 px-1 rounded-sm">⏹ Выйти из эфира</code> закрывает активный PDF, видеофайл или презентацию PowerPoint, освобождает их тяжёлые ресурсы и затем показывает подложку. Если подложка не настроена — внешний экран освобождается</li>
                  <li>Камера, плата видеозахвата или захват окна после выхода убираются из эфира, но могут оставаться подключёнными для быстрого возврата, пока источник назначен каналу. Удаление источника из канала или закрытие PDM останавливает поток</li>
                  <li>Небольшой базовый расход Electron и системных библиотек остаётся для быстрого следующего показа; после закрытия память не обязана мгновенно упасть до нуля, но тяжёлый материал не должен накапливаться от запуска к запуску</li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>Если назначенный монитор отключён, PDM закрывает только его окно и не переносит изображение на другой экран. При возвращении того же монитора после краткого переключения входа его роль и вывод восстанавливаются автоматически</li>
                </ul>
              </section>
