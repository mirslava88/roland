            ...
            <div className="space-y-5 text-xs text-gray-300 leading-relaxed">
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>Укажите название мероприятия, время начала и окончания, заголовок, стоимость минуты, один цвет, градиент из двух цветов с выбранным углом или фоновое изображение</li>
                  ...
                  <li>Нижняя строка «Осталось времени» показывает реальную разницу между окончанием мероприятия и текущим временем</li>
