            ...
            <div className="space-y-5 text-xs text-gray-300 leading-relaxed">
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-gray-400">
                  ...
                  <li>В единственном окне предпросмотра таймер можно перетаскивать мышью и менять колёсиком, а круглая стрелка ↻ передаёт подготовленное положение в основной эфир. Если включено «Отправить в суфлёр», над тем же окном можно выбрать «Основной эфир» или «Суфлёр» и независимо настроить каждый выход</li>
