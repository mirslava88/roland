...
- **PowerPoint** — превью всех слайдов, переход к нужному слайду, next/prev и нативное слайд-шоу через Microsoft PowerPoint. Сразу после добавления PPTX в канал PDM скрыто открывает её в PowerPoint, готовит превью и полноразмерные кадры. Пока видна метка **«Кэширование…»**, кнопка выхода в эфир недоступна; после завершения презентация уже загружена и готова к показу. При выходе Roland закрывает только созданные им презентации, а уже открытое пользовательское окно возвращает в исходное состояние.
