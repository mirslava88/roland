...
Чтобы вывести табло, назначьте монитору режим **«Таймер мероприятия»** в окне **«Экраны»** и нажмите **«Отправить в эфир»**. После этого любые изменения видны только в превью и не меняют изображение зрителей. Кнопка **«Обновить эфир»** применяет подготовленный вариант, а **«Убрать из эфира»** отключает табло. Параметры сохраняются в `.pdmconfig`, но после загрузки конфигурации таймер остаётся остановленным и не выходит в эфир автоматически.
