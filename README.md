...
## Последнее обновление 1.1.4

- Закрытие PDF, видеофайла, PPT и PPTX теперь освобождает тяжёлые ресурсы: документы, декодеры, холсты, PDF-воркеры и презентации PowerPoint, открытые самим PDM.
- Переключение PowerPoint стало транзакционным: предыдущий эфир сохраняется до подтверждения нового, а при сбое PDM восстанавливает прежнее слайд-шоу и точный слайд. Если безопасное восстановление подтвердить нельзя, на выходе остаётся защитный кадр.
- PDM отличает собственные окна и документы Office от пользовательских: самостоятельно открытые PowerPoint, Word и Excel не закрываются принудительно.
- Поздно завершившиеся операции PDF, видео и переходов больше не могут вернуть уже закрытый материал в память или заменить новый готовый кадр.
- Живая копия камеры, платы видеозахвата, окна или экрана ждёт первый реально отрисованный кадр, автоматически переподключается после краткого сбоя и сохраняет титры с таймером.
