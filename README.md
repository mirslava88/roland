...
- **Окна программ и экраны** — автоматический список открытых окон, показ браузера, Word, Excel, Проводника, командной строки или целого экрана. Свёрнутое окно развернётся только после нажатия **«В эфир»**; браузер при этом автоматически переходит в режим F11 и возвращается в обычное окно при выходе из эфира.
