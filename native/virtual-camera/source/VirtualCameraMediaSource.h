...
// {BBEF2CB0-96F5-4C1E-86F6-6B7670CAB609}
DEFINE_GUID(CLSID_VirtualCameraMediaSource ,
    0xbbef2cb0, 0x96f5, 0x4c1e, 0x86, 0xf6, 0x6b, 0x76, 0x70, 0xca, 0xb6, 0x09);

static LPCWSTR VIRTUALCAMERAMEDIASOURCE_CLSID = L"{BBEF2CB0-96F5-4C1E-86F6-6B7670CAB609}";
static LPCWSTR VIRTUALCAMERAMEDIASOURCE_FRIENDLYNAME = L"PDM Virtual Camera Media Source";
